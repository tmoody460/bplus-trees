...
void create_tree(int key, char* value);
void get_leaf(int key, char* leaf);
void insert_without_split(char* leaf_filename, int key, char* value);
void insert_with_split(char* leaf_filename, int key, char* value);
void insert_key_into_parent(int key, char* old_child, char* new_child);
void insert_node_with_split(char* old_child, char* new_child, int key, int index);
...
void insert_node_with_split(char* parent, char* new_child, int key, int index){
